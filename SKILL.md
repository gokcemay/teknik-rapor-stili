...
description: Google developer documentation style guide'ı teknik rapor türüne uyarlayan yazım ve düzenleme kuralları (Türkçe ve İngilizce). Teknik rapor, deney raporu, test raporu, proje ara/sonuç raporu, danışmanlık dönem raporu, fizibilite, SOP, teknik doküman veya kullanım kılavuzu yazılırken, mevcut bir raporun dili/biçimi denetlenirken, ya da bir raporun TR-EN çevirisi/ikinci dile uyarlaması yapılırken bu skill'i mutlaka kullan. "Teknik rapor yaz", "raporu düzenle", "bu metni rapor diline çevir", "stil kontrolü yap", "technical report", "style check", "Google style" gibi ifadeler geçtiğinde tetiklenir. Kullanıcı açıkça "stil kılavuzu" demese bile, çıktı bir teknik rapor veya teknik doküman ise bu kuralları uygula.
---
